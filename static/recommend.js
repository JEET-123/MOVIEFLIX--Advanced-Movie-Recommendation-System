$(function() {
  ...
  $('.movie-button').on('click',function(){
    var my_api_key = 'e19f07b69b7d703bcf5e348017363f12';
    var title = $('.movie').val();
    if (title=="") {
...
// get the basic details of the typed movie from the API (based on the name of the movie)
...
// passing the typed movie name to get the similar movies from python's flask
...
// get all the details of the recommended movies using the movie id.
...
// passing all the details of recommended movies to python's flask for displaying and scraping the movie reviews using imdb id
